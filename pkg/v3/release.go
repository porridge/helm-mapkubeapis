...
func MapReleaseWithUnSupportedAPIs(mapOptions common.MapOptions, extra ...*mapping.Mapping) error {
	...
	modifiedManifest, err := common.ReplaceManifestUnSupportedAPIs(origManifest, mapOptions.MapFile, mapOptions.KubeConfig, extra...)
	if err != nil {
		return err
	}
